"""Camera entity for Chickadee integration."""
...
async def async_setup_entry(
    ...
    """Set up Chickadee camera."""
    coordinator: ChickadeeCoordinator = hass.data[DOMAIN][entry.entry_id]
    device_id = entry.data[CONF_DEVICE_ID]

    entities = [
        ChickadeeCamera(coordinator, device_id),
    ]

    async_add_entities(entities)


class ChickadeeCamera(ChickadeeEntity, Camera):
    """Camera entity for Chickadee device."""
