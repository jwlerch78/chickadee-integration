"""Number entities for Chickadee integration."""
...
async def async_setup_entry(
    ...
    """Set up Chickadee number entities."""
    ...
    entities = [
        ...
        # =================================================================
        ChickadeeBrightnessNumber(coordinator, device_id),
        ChickadeeVolumeNumber(coordinator, device_id),

        # =================================================================
        # CONFIGURATION (CONFIG category)
        # =================================================================
        ChickadeeZoomNumber(coordinator, device_id),
    ]

    async_add_entities(entities)


class ChickadeeBrightnessNumber(ChickadeeEntity, NumberEntity):
...
class ChickadeeVolumeNumber(ChickadeeEntity, NumberEntity):
...
class ChickadeeZoomNumber(ChickadeeEntity, NumberEntity):
