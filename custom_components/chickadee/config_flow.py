...
def _select_discovery_host(discovery_info) -> str | None:
    ...
    Chickadee devices advertise an IPv4 plus IPv6 (ULA + ``fe80::`` link-local).
...
class ChickadeeConfigFlow(config_entries.ConfigFlow, domain=DOMAIN):
    """Handle a config flow for Chickadee."""
    ...
    async def async_step_zeroconf(self, discovery_info: Any) -> FlowResult:
        ...
        device_name = properties.get("name", discovery_info.name or "Chickadee")
        ...
        try:
            ...
            if device_id:
                ...
                self._is_chickadee = True  # Zeroconf discovery is Chickadee only
        ...
        if user_input is not None:
            ...
            try:
                ...
                if device_id:
                    ...
                    base_name = self._device_info.get("deviceName", "Chickadee")
        ...
        if user_input is not None:
            ...
            try:
                ...
                if device_id:
                    ...
                    return self.async_create_entry(
                        title=self._device_info.get("deviceName", "Chickadee"),
                        data={
                            CONF_HOST: self._host,
                            CONF_PORT: self._port,
                            CONF_PASSWORD: self._password,
...
class ChickadeeOptionsFlow(config_entries.OptionsFlow):
    """Handle Chickadee options."""
    ...
    async def async_step_init(
        ...
        return self.async_show_form(
            ...
            errors=errors,
            description_placeholders={
                "device_name": self.config_entry.data.get(CONF_DEVICE_NAME, "Chickadee"),
            },
        )
