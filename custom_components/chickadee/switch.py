"""Switch entities for Chickadee integration."""
...
async def async_setup_entry(
    ...
    entities = [
        ...
        # =================================================================
        ChickadeeScreenSwitch(coordinator, device_id),
        ChickadeeScreensaverSwitch(coordinator, device_id),
        ChickadeeLockSwitch(coordinator, device_id),

        # =================================================================
        # DISPLAY (CONFIG category with "Display:" prefix)
        # =================================================================
        ChickadeeKeepScreenOnSwitch(coordinator, device_id),
        ChickadeeAutoBrightnessSwitch(coordinator, device_id),
        ChickadeeDarkModeSwitch(coordinator, device_id),  # Requires WRITE_SECURE_SETTINGS permission

        # =================================================================
        # CAMERA (CONFIG category with "Camera:" prefix)
        # =================================================================
        ChickadeeRtspStreamSwitch(coordinator, device_id),
        ChickadeeSoftwareEncodingSwitch(coordinator, device_id),

        # =================================================================
        # CONFIGURATION (CONFIG category with "Config:" prefix)
        # =================================================================
        ChickadeeHideSidebarSwitch(coordinator, device_id),
        ChickadeeHideTabsSwitch(coordinator, device_id),

        # =================================================================
        # SYSTEM (CONFIG category with "System:" prefix)
        # =================================================================
        ChickadeeStartOnBootSwitch(coordinator, device_id),
    ]

    async_add_entities(entities)


class ChickadeeScreenSwitch(ChickadeeEntity, SwitchEntity):
...
class ChickadeeScreensaverSwitch(ChickadeeEntity, SwitchEntity):
...
class ChickadeeLockSwitch(ChickadeeEntity, SwitchEntity):
...
class ChickadeeDarkModeSwitch(ChickadeeEntity, SwitchEntity):
    """Dark mode switch."""
...
class ChickadeeHideSidebarSwitch(ChickadeeEntity, SwitchEntity):
...
class ChickadeeHideTabsSwitch(ChickadeeEntity, SwitchEntity):
...
class ChickadeeKeepScreenOnSwitch(ChickadeeEntity, SwitchEntity):
...
class ChickadeeAutoBrightnessSwitch(ChickadeeEntity, SwitchEntity):
...
class ChickadeeStartOnBootSwitch(ChickadeeEntity, SwitchEntity):
...
class ChickadeeRtspStreamSwitch(ChickadeeEntity, SwitchEntity):
...
class ChickadeeSoftwareEncodingSwitch(ChickadeeEntity, SwitchEntity):
