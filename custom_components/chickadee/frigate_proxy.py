...
Endpoints:
  GET /api/chickadee/frigate/cameras
  GET /api/chickadee/frigate/events
  GET /api/chickadee/frigate/recordings/{camera}/summary
  GET /api/chickadee/frigate/{camera}/{start}/{end}/clip.mp4
  GET /api/chickadee/frigate/event/{event_id}/clip.mp4
  GET /api/chickadee/frigate/event/{event_id}/thumbnail.jpg
...
class FrigateCamerasView(HomeAssistantView):
    """GET /api/chickadee/frigate/cameras — list Frigate cameras."""

    url = "/api/chickadee/frigate/cameras"
    name = "api:chickadee:frigate:cameras"
    requires_auth = True
...
class FrigateEventsView(HomeAssistantView):
    """GET /api/chickadee/frigate/events?camera=X&after=ts&before=ts&limit=50."""

    url = "/api/chickadee/frigate/events"
    name = "api:chickadee:frigate:events"
    requires_auth = True
...
class FrigateRecordingSummaryView(HomeAssistantView):
    ...
    url = "/api/chickadee/frigate/recordings/{camera}/summary"
    name = "api:chickadee:frigate:recordings:summary"
    requires_auth = True
...
class FrigateClipView(HomeAssistantView):
    ...
    url = "/api/chickadee/frigate/{camera}/{start}/{end}/clip.mp4"
    name = "api:chickadee:frigate:clip"
    requires_auth = True
...
class FrigateEventClipView(HomeAssistantView):
    ...
    url = "/api/chickadee/frigate/event/{event_id}/clip.mp4"
    name = "api:chickadee:frigate:event:clip"
    requires_auth = True
...
class FrigateEventThumbnailView(HomeAssistantView):
    ...
    url = "/api/chickadee/frigate/event/{event_id}/thumbnail.jpg"
    name = "api:chickadee:frigate:event:thumbnail"
    requires_auth = True
