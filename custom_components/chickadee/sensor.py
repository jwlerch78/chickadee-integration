"""Sensor entities for Chickadee integration."""
...
async def async_setup_entry(
    ...
    entities = [
        ...
        # =================================================================
        ChickadeeLightSensor(coordinator, device_id),

        # =================================================================
        # CAMERA INFO (DIAGNOSTIC category - read-only camera settings)
        # =================================================================
        ChickadeeCameraFrameRateSensor(coordinator, device_id),
        ChickadeeCameraResolutionSensor(coordinator, device_id),
        ChickadeeCameraStreamUrlSensor(coordinator, device_id),

        # =================================================================
        # STATUS (DIAGNOSTIC category, shown in Status section)
        # =================================================================
        ChickadeeAndroidVersionSensor(coordinator, device_id),
        ChickadeeAppVersionSensor(coordinator, device_id),
        ChickadeeBatterySensor(coordinator, device_id),
        ChickadeeCurrentPageSensor(coordinator, device_id),
        ChickadeeDeviceIdSensor(coordinator, device_id),
        ChickadeeRamUsageSensor(coordinator, device_id),
        ChickadeeStorageSensor(coordinator, device_id),
        ChickadeeWifiSignalSensor(coordinator, device_id),
        ChickadeeWifiRssiSensor(coordinator, device_id),
    ]

    async_add_entities(entities)


class ChickadeeBatterySensor(ChickadeeEntity, SensorEntity):
...
class ChickadeeLightSensor(ChickadeeEntity, SensorEntity):
...
class ChickadeeCurrentPageSensor(ChickadeeEntity, SensorEntity):
...
class ChickadeeWifiSignalSensor(ChickadeeEntity, SensorEntity):
...
class ChickadeeWifiRssiSensor(ChickadeeEntity, SensorEntity):
    """WiFi signal strength sensor in dBm (raw RSSI).

    Complements ChickadeeWifiSignalSensor (0-100 quality level): dBm is the standard
...
class ChickadeeStorageSensor(ChickadeeEntity, SensorEntity):
...
class ChickadeeDeviceIdSensor(ChickadeeEntity, SensorEntity):
...
class ChickadeeRamUsageSensor(ChickadeeEntity, SensorEntity):
...
class ChickadeeAndroidVersionSensor(ChickadeeEntity, SensorEntity):
...
class ChickadeeAppVersionSensor(ChickadeeEntity, SensorEntity):
    """App version sensor - Chickadee version."""
...
class ChickadeeCameraFrameRateSensor(ChickadeeEntity, SensorEntity):
...
class ChickadeeCameraResolutionSensor(ChickadeeEntity, SensorEntity):
...
class ChickadeeCameraStreamUrlSensor(ChickadeeEntity, SensorEntity):
