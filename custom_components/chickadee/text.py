...
"""Text entities for Chickadee integration."""
...
async def async_setup_entry(
    ...
    """Set up Chickadee text entities."""
    ...
    entities = [
        ...
        # =================================================================
        ChickadeePinText(coordinator, device_id),
        ChickadeeLoadUrlText(coordinator, device_id),

        # =================================================================
        # CONFIGURATION (CONFIG category)
        # =================================================================
        ChickadeeDashboardUrlText(coordinator, device_id),
    ]
...
class ChickadeeDashboardUrlText(ChickadeeEntity, TextEntity):
...
class ChickadeeLoadUrlText(ChickadeeEntity, TextEntity):
...
class ChickadeePinText(ChickadeeEntity, TextEntity):
